 ...
 * @version 1.0.0
 */
public class BaseRecyclerPresenter<ViewMode, View extends BaseConstarct.RecyclerView> extends BasePresenter<View> {
    ...
    protected void refreshData(final List<ViewMode> dataList) {
        Run.onUiAsync(new Action() {
            ...
            public void call() {
                ...
                // 基本的更新数据并刷新界面
                RecyclerAdapter<ViewMode> adapter = view.getRecyclerViewApater();
